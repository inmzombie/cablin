...
namespace Jhonny\Bundle\AdministradorBundle\Controller;
...
class ClienteController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('AdministradorBundle:Cliente')
    ...
    */
    private function createFilterForm($filterData = null)
    {
        $form = $this->createForm(new ClienteFilterType(), $filterData, array(
            'action' => $this->generateUrl('admin_cliente'),
            'method' => 'GET',
        ));
     ...
     * @Method("POST")
     * @Template("AdministradorBundle:Cliente:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $nextAction = $form->get('saveAndAdd')->isClicked()
                    ? $this->generateUrl('admin_cliente_new')
                    : $this->generateUrl('admin_cliente_show', array('id' => $entity->getId()));
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AdministradorBundle:Cliente')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AdministradorBundle:Cliente:edit.html.twig")
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            $nextAction = $editForm->get('saveAndAdd')->isClicked()
                        ? $this->generateUrl('admin_cliente_new')
                        : $this->generateUrl('admin_cliente_show', array('id' => $id));
            return $this->redirect($nextAction);
        }
